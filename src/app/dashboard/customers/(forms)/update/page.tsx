...
export default function Page(): React.JSX.Element {
				...
				<Card>
					<CardContent>
						<Stack spacing={2} alignItems="center" textAlign="center">
							<Typography variant="h5">Thiếu tham số</Typography>
							<Typography variant="body2" color="text.secondary">
								Vui lòng truy cập với dạng <code>/dashboard/customers/update?id=...</code>
							</Typography>
	...
	return (
		<Stack spacing={3} sx={{ width: "100%" }}>
			<Card sx={{ width: "100%" }}>
				<CardHeader title="Thông tin hồ sơ" subheader="Cập nhật thông tin bên dưới" />
				<Divider />
				<CardContent>
					<Stack spacing={3} sx={{ width: "100%" }}>
